		...
		>
			...
			>
				<TouchableOpacity
					...
					onPress={() => { navigate('FlatListAddedMusicsPage', { playlistId: playlistChanges.playlistId }) }}
				>
					<View>
						<Text style={[
							styles.buttonText,
			...
			>
				<TouchableOpacity
					...
					onPress={() => { navigate('FlatListRemovedMusicsPage', { playlistId: playlistChanges.playlistId }) }}
				>
					<View>
						<Text style={[
							styles.buttonText,

...
const PlaylistData: React.FC<PlaylistDataProps> = ({
  totalTracks,
  followers,
  isPublic,
  collaborative,
  ...
  return (
    <ContentBox title="Playlist Info">
      <View style={[styles.InfoContainer, {borderTopWidth: 0, paddingTop: 0}]}>
        ...
        <Text style={styles.infoText}>{totalTracks}</Text>
      </View>
      ...
      <View style={styles.InfoContainer}>
        ...
        <Text style={styles.infoText}>{isPublic ? 'True' : 'False'}</Text>
      </View>

      <View style={styles.InfoContainer}>
        <Text style={styles.InfoTitleText}>Collaborative:</Text>
        <Text style={styles.infoText}>{collaborative ? 'True' : 'False'}</Text>
      </View>
    </ContentBox>
  );
};

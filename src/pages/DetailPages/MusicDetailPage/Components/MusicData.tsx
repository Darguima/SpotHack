...
const MusicData: React.FC<MusicDataProps> = ({
  title,
  artists,
  duration,
  explicit,
  ...
  return (
    <ContentBox title="Music Info">
      ...
      <View style={styles.InfoContainer}>
        ...
        <Text style={styles.infoText}>{artists}</Text>
      </View>
      ...
      <View style={styles.InfoContainer}>
        ...
        <Text style={styles.infoText}>
          {`${
            convertMilisecondsToMinutes(duration).minutes
          } min ${convertMilisecondsToMinutes(duration)
            .seconds.toString()
            .padStart(2, '0')} sec`}
        </Text>
      </View>

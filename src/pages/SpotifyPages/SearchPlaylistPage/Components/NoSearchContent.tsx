  ...
  return (
    <View style={styles.container}>
      <View style={styles.topContainer}>
        <Text
          style={[
            styles.screenToogleText,
            screenIndex === 0 ? styles.screenToogleTextSelected : {},
          ]}
          onPress={() => {
            setScreenIndex(0);
          }}>
        ...
        <Text
          style={[
            styles.screenToogleText,
            screenIndex === 1 ? styles.screenToogleTextSelected : {},
          ]}
          onPress={() => {
            setScreenIndex(1);
          }}>
      ...
      {screenIndex === 0 &&
        playlistSearchHistory.map((item, index) => {
          return (
            <MusicPlaylistView
              key={index}
              style={{
                ...
                marginBottom:
                  index === playlistSearchHistory.length - 1 ? '4%' : '2%',
              }}

...
const Filters:React.FC<FiltersProps> = ({ playlistsOnQueue, playlistIdToFilter, setPlaylistIdToFilter }) => {
	const [showFilters, setShowFilters] = useState(false)

	const {
		saveNewSpotHackSettings,
		spotHackSettings: { downloadsPage: { showAlreadyDownloadedMusics } }
	} = useSpotHackSettings()
		...
		<View style={styles.container}>
			...
			{showFilters &&
				<View style={styles.filtersContainer}>
					<View style={styles.filterOption}>
						...
						<View style={styles.playlistPickerContainer}>
							<Picker
								...
								onValueChange={(itemValue) => setPlaylistIdToFilter(itemValue as string)}
							>
					...
					<View style={styles.filterOption}>
						<Text style={styles.filterOptionText}>Show Already Downloaded Musics: </Text>
						<Switch
							onValueChange={(value) => {
								saveNewSpotHackSettings({
									downloadsPage: {

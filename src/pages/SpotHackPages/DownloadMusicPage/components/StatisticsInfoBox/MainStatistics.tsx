...
const MainStatistics:React.FC<MainStatisticsProps> = ({ downloadStatistics: dlStatistics, showAlreadyDownloadedMusics }) => {
	return (
		<View
			style={styles.mainStatisticsContainer}
		>
			...
			<View style={styles.statusContainers}>
				...
				<Text style={styles.iconText}>
					{showAlreadyDownloadedMusics
						? dlStatistics.downloadedMusics + dlStatistics.alreadyDownloadedMusics

...
const Header:React.FC<HeaderProps> = ({ rootPath, setRootPath, rootPaths, goBackDisabled = false }) => {
		...
		<View style={styles.header}>
			...
			{rootPath && setRootPath && rootPaths &&
				<View style={styles.contentContainer}>
					...
					>
						{rootPaths.map((rootPath, index) => <Picker.Item key={index} label={rootPath} value={rootPath} />)}
					</Picker>
				</View>
			}

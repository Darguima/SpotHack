...
export default async function (this: DownloadManager) {
	...
	this.downloadsInfo = await verifyFileTree(this.downloadsInfo, this.apiUpdatedPlaylists)

	this.playlistsChanges = await verifyPlaylistsChanges(this.downloadsInfo, this.apiUpdatedPlaylists)

...
interface AppUtilsContextData {
  ...
  setChangeMusicSearchInputValue: React.Dispatch<
    React.SetStateAction<() => (newValue: string) => void>
  >;

  changePlaylistSearchInputValue: (newValue: string) => void;
  setChangePlaylistSearchInputValue: React.Dispatch<
    React.SetStateAction<() => (newValue: string) => void>
  >;
}

const AppUtilsContext = createContext<AppUtilsContextData>(
  {} as AppUtilsContextData,
);

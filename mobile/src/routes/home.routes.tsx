...
const HomeRoutes: React.FC = () => {
	...
	return (
		<Navigator screenOptions={{ headerShown: false }}>
			...
			<Screen name="AddUnrecognizedPlaylistPage" component={AddUnrecognizedPlaylistPage} />
...
export const homeStackUseNavigator = () => useNavigation<HomeStackNavigationProp>()

export type HomeScreenParamsListProp< RouteName extends keyof HomeStackParamsList > = StackScreenProps<HomeStackParamsList, RouteName>

...
const DownloadProgressView:React.FC<DownloadProgressViewProps> = ({
	musicInfo, style, contentBackgroundColor = '#212121'
}) => {
	...
	return (
		<View style={[styles.container, { backgroundColor: contentBackgroundColor }, style || {}]}>
			<View style={styles.musicViewContainer}>
				<MemoizedMusicPlaylistView musicInfo={musicInfo} contentBackgroundColor={contentBackgroundColor}/>
			</View>
			...
			<View style={styles.statusViewContainer}>
				<View style={styles.statusIconsContainers}>
					<MaterialCommunityIcons
						name={'database'}
						style={{ color: convertCodeAndErrorsToColor(1, musicInfo.progress, musicInfo.stage) }}
						size={22}
					/>
				</View>
				...
				<View style={styles.statusIconsContainers}>
					<MaterialCommunityIcons
						name={'download'}
						style={{ color: convertCodeAndErrorsToColor(2, musicInfo.progress, musicInfo.stage) }}
						size={22}
					/>
				</View>
				...
				<View style={styles.statusIconsContainers}>
					<MaterialCommunityIcons
						name={'music-note'}
						style={{ color: convertCodeAndErrorsToColor(3, musicInfo.progress, musicInfo.stage) }}
						size={22}
					/>
				</View>
				...
				<View style={styles.statusIconsContainers}>
					<MaterialCommunityIcons
						name={'content-save'}
						style={{ color: convertCodeAndErrorsToColor(4, musicInfo.progress, musicInfo.stage) }}
						size={22}
					/>
				</View>
				...
				<View style={styles.statusIconsContainers}>
					<Text
						style={[
							...
							{
								color: (musicInfo.stageProgress === 0 || musicInfo.stageProgress === 100)
									? '#000'
									: '#fff'
							}
						]}
			...
			<View style={styles.errorsContainer}>
				...
				>
					<Text
						...
						onTextLayout={e => setErrorMessageNumOfLines(e.nativeEvent.lines.length)}
					>
						{musicInfo.stage}
					</Text>
